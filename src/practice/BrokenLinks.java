...
public class BrokenLinks {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Size of all links and image links " + linkslist.size());
		// create one more list to store only active links
		...
		System.out.println("Size of active links and image links " + activelinks.size());
		for (int j = 0; j < activelinks.size(); j++) {
			...
			try {
				...
				if (con.getResponseCode() == HttpURLConnection.HTTP_NOT_FOUND) {
					System.out.println(
							linksurl + " - " + con.getResponseMessage() + " - " + HttpURLConnection.HTTP_NOT_FOUND);
				}
